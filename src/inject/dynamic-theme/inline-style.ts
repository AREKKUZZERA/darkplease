...
import {encodeTextAsBase64} from '../../utils/text';
...
const overrides: Overrides = {
    'background-color': {
        customProp: '--darkplease-inline-bgcolor',
        cssProp: 'background-color',
        dataAttr: 'data-darkplease-inline-bgcolor',
    },
    'background-image': {
        customProp: '--darkplease-inline-bgimage',
        cssProp: 'background-image',
        dataAttr: 'data-darkplease-inline-bgimage',
    },
    'border-color': {
        customProp: '--darkplease-inline-border',
        cssProp: 'border-color',
        dataAttr: 'data-darkplease-inline-border',
    },
    'border-bottom-color': {
        customProp: '--darkplease-inline-border-bottom',
        cssProp: 'border-bottom-color',
        dataAttr: 'data-darkplease-inline-border-bottom',
    },
    'border-left-color': {
        customProp: '--darkplease-inline-border-left',
        cssProp: 'border-left-color',
        dataAttr: 'data-darkplease-inline-border-left',
    },
    'border-right-color': {
        customProp: '--darkplease-inline-border-right',
        cssProp: 'border-right-color',
        dataAttr: 'data-darkplease-inline-border-right',
    },
    'border-top-color': {
        customProp: '--darkplease-inline-border-top',
        cssProp: 'border-top-color',
        dataAttr: 'data-darkplease-inline-border-top',
    },
    'box-shadow': {
        customProp: '--darkplease-inline-boxshadow',
        cssProp: 'box-shadow',
        dataAttr: 'data-darkplease-inline-boxshadow',
    },
    'color': {
        customProp: '--darkplease-inline-color',
        cssProp: 'color',
        dataAttr: 'data-darkplease-inline-color',
    },
    'fill': {
        customProp: '--darkplease-inline-fill',
        cssProp: 'fill',
        dataAttr: 'data-darkplease-inline-fill',
    },
    'stroke': {
        customProp: '--darkplease-inline-stroke',
        cssProp: 'stroke',
        dataAttr: 'data-darkplease-inline-stroke',
    },
    'outline-color': {
        customProp: '--darkplease-inline-outline',
        cssProp: 'outline-color',
        dataAttr: 'data-darkplease-inline-outline',
    },
    'stop-color': {
        customProp: '--darkplease-inline-stopcolor',
        cssProp: 'stop-color',
        dataAttr: 'data-darkplease-inline-stopcolor',
    },
};

const shorthandOverrides: Overrides = {
    'background': {
        customProp: '--darkplease-inline-bg',
        cssProp: 'background',
        dataAttr: 'data-darkplease-inline-bg',
    },
    'border': {
        customProp: '--darkplease-inline-border-short',
        cssProp: 'border',
        dataAttr: 'data-darkplease-inline-border-short',
    },
    'border-bottom': {
        customProp: '--darkplease-inline-border-bottom-short',
        cssProp: 'border-bottom',
        dataAttr: 'data-darkplease-inline-border-bottom-short',
    },
    'border-left': {
        customProp: '--darkplease-inline-border-left-short',
        cssProp: 'border-left',
        dataAttr: 'data-darkplease-inline-border-left-short',
    },
    'border-right': {
        customProp: '--darkplease-inline-border-right-short',
        cssProp: 'border-right',
        dataAttr: 'data-darkplease-inline-border-right-short',
    },
    'border-top': {
        customProp: '--darkplease-inline-border-top-short',
        cssProp: 'border-top',
        dataAttr: 'data-darkplease-inline-border-top-short',
    },
};
...
export function overrideInlineStyle(element: HTMLElement, theme: Theme, ignoreInlineSelectors: string[], ignoreImageSelectors: string[]): void {
    ...
    function setCustomProp(targetCSSProp: string, modifierCSSProp: string, cssVal: string) {
        ...
        function setAsyncValue(promise: Promise<string | null>, sourceValue: string) {
            promise.then((value) => {
                if (value && targetCSSProp === 'background' && value.startsWith('var(--darkplease-bg--')) {
    ...
    if (isSVGElement && theme.mode === 1 && svg) {
        ...
        if (shouldAnalyzeSVGAsImage(svg)) {
            ...
            const analyzeSVGAsImage = () => {
                ...
                svgString = svgString.replaceAll('<style class="darkplease darkplease--sync" media="screen"></style>', '');
                const dataURL = `data:image/svg+xml;base64,${encodeTextAsBase64(svgString)}`;
                getImageDetails(dataURL).then((details) => {
                    if (
                        ...
                        svg.setAttribute('data-darkplease-inline-invert', '');
                    } else {
                        svg.removeAttribute('data-darkplease-inline-invert');
                    }
                });
            };
            analyzeSVGAsImage();
