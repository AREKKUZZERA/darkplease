...
export function injectStyleAway(styleElement: HTMLStyleElement | SVGStyleElement) {
    ...
    let container: HTMLElement | null = document.body.querySelector('.darkplease-style-container');
    if (!container) {
        container = document.createElement('div');
        container.classList.add('darkplease');
        container.classList.add('darkplease-style-container');
        ...
        containerObserver = new MutationObserver(() => {
            if (container?.nextElementSibling != null) {
                ...
                container.querySelectorAll('.darkplease--sync').forEach((el: HTMLStyleElement) => {
...
export function removeStyleContainer() {
    ...
    document.querySelector('.darkplease-style-container')?.remove();
}
