    ...
    if (modified.startsWith('var(') && modified.endsWith(')')) {
        ...
        if (hasNestedBrackets) {
            return (
                ...
                fallback.startsWith('var(--darkplease-bg--') ||
                fallback.startsWith('var(--darkplease-background-') ||
                (hasDoubleNestedBrackets && fallback.includes('var(--darkplease-background-'))
            );
        }
