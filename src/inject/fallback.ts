...
if (
    ...
    !document.querySelector('.darkplease') &&
    ...
    const css = [
        ...
        // https://github.com/AREKKUZZERA/darkplease/issues/3618
        'div[style*="background-color: rgb(135, 135, 135)"] {',
        '    background-color: #878787 !important;',
        '}',
    ].join('\n');
    const fallback = document.createElement('style');
    fallback.classList.add('darkplease');
    fallback.classList.add('darkplease--fallback');
...
if (__FIREFOX_MV2__ && (location.host === 'teams.live.com' || location.host === 'teams.microsoft.com')) {
    ...
    (() => {
        ...
        Object.defineProperty(CSSStyleSheet.prototype, 'cssRules', {
            ...descriptor,
            get: function () {
                if (this.ownerNode?.classList?.contains('darkplease')) {
                    return [];
                }
