declare namespace DarkPlease {
    ...
    /**
     * Returns if DARK PLEASE! is enabled.
     */
    ...
    /**
     * Returns the generated CSS by DARK PLEASE! as a string.
     */
    ...
    interface DynamicThemeFix {
         ...
         * who are using the DARK PLEASE! API.
         */
        disableStyleSheetsProxy: boolean;
        /**
         * List of stylesheet URL patterns to ignore.
         * Stylesheets matching these patterns will not be processed by DARK PLEASE!.
