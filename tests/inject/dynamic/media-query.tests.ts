...
describe('MEDIA QUERIES', () => {
    it('should not style blacklisted media', async () => {
        ...
        expect(document.querySelector('.testcase-style-2').nextElementSibling.classList.contains('darkplease--sync')).toBe(false);
    });
    ...
    it('should style lazyloaded media', async () => {
        ...
        expect(getComputedStyle(document.querySelector('h1')).backgroundColor).toBe('rgb(0, 102, 0)');
        expect(getComputedStyle(document.querySelector('h1 strong')).color).toBe('rgb(255, 174, 26)');
        expect(document.querySelector('.testcase-style').nextElementSibling.classList.contains('darkplease--sync')).toBe(true);
    });
    ...
    it('should style print/media query', () => {
        ...
        expect(document.querySelector('.testcase-style-2').nextElementSibling.classList.contains('darkplease--sync')).toBe(true);
    });
