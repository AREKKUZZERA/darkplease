...
describe('INLINE STYLES', () => {
    ...
    it('should clean up the customProp after originial is gone', async () => {
        ...
        createOrUpdateDynamicTheme(theme, null, false);
        const span = document.querySelector('span');
        expect(span.getAttribute('style').startsWith('color: red; --darkplease-inline-color:')).toBeTrue();
        expect(span.getAttribute('style').includes('--darkplease-inline-color: var(--darkplease-text-ff0000, #ff1a1a);')).toBe(true);
