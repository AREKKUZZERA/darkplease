...
describe('SHADOW DOM', () => {
    it('should add static overrides', async () => {
        ...
        expect(shadowRoot.firstElementChild.classList.contains('darkplease--inline')).toBe(true);
        expect(shadowRoot.firstElementChild.nextElementSibling.classList.contains('darkplease--override')).toBe(true);
        expect(shadowRoot.firstElementChild.nextElementSibling.nextElementSibling.classList.contains('darkplease--invert')).toBe(true);
    });
    ...
    it('should override styles', async () => {
        ...
        expect(testCase.nextElementSibling.classList.contains('darkplease--sync')).toBe(true);
