...
it('URL is enabled', () => {
    ...
    expect(isURLEnabled(
        'https://darkplease.org/',
        fillUserSettings({disabledFor: [], enabledFor: [], enabledByDefault: true}),
        {isProtected: false, isInDarkList: true},
    )).toBe(false);
    expect(isURLEnabled(
        'https://darkplease.org/',
        fillUserSettings({disabledFor: [], enabledFor: ['darkplease.org'], enabledByDefault: false}),
        {isProtected: false, isInDarkList: true},
    )).toBe(true);
    expect(isURLEnabled(
    ...
    expect(isURLEnabled(
        'https://darkplease.org/',
        fillUserSettings({disabledFor: [], enabledFor: ['darkplease.org'], enabledByDefault: true}),
        {isProtected: false, isInDarkList: true},
    )).toBe(true);
    expect(isURLEnabled(
        'https://darkplease.org/',
